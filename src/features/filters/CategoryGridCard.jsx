...
const CategoryGridCard = memo(({ opt, idx, handleSelectOption, isMobile }) => {
  return (
    ...
    >
      ...
      <div className="absolute bottom-2 left-2 right-2 sm:bottom-3 sm:left-3 sm:right-3 p-1.5 sm:p-2.5 md:p-3 bg-slate-950/80 dark:bg-slate-950/90 backdrop-blur-md border border-white/10 rounded-[10px] sm:rounded-[12px] flex flex-col items-center justify-center z-20 shadow-lg pointer-events-none">
