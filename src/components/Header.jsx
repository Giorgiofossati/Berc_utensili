...
import { Calendar, User, History, Database, LogOut, ChevronRight, Search } from 'lucide-react';
        ...
        >
          <div className="flex items-center gap-1.5 md:gap-2.5">
            <div className="text-right">
              <p className="text-[7px] md:text-[8px] font-black uppercase tracking-[0.1em] md:tracking-[0.2em] text-slate-300 leading-none mb-0.5 hidden sm:block">{currentUser?.ruolo || 'Guest'}</p>
              <p className="font-extrabold text-[9px] md:text-[10px] tracking-widest text-slate-200 uppercase">{currentUser?.nome || 'User'}</p>
            </div>
